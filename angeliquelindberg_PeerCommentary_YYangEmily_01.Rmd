...
str(df)
```
<p style="color: #0000ff;">EY: We did it the same way! I'd maybe add a little comment about the coercing data classes because you say what you're doing in the chunk naming but can't see that in html. Good job!</p>
