...
```
<p style="color: #0000ff;">EY: Your use of gsub is very interesting. I think I'm missing something from your explanation </p>
...
```
<p style="color: #0000ff;">EY: Interesting instead of the last word in every group of 3 it picked the first word of the 3. Are you able to get it to pick the last of each set?</p>
...
y
```
<p style="color: #0000ff;">EY: We did it the same way!</p>
...
Primates
```
<p style="color: #0000ff;">We did it the same way!</p>
...
str(df)
```
<p style="color: #0000ff;">We did it the same way! I'd maybe add a little more comments because you say what you're doing in the chunk naming but can't see that in html</p>
